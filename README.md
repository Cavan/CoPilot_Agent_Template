...
This project includes six example agents in [.github/agents/](.github/agents/):
...
Agents become powerful when combined. See [docs/composing-agents.md](docs/composing-agents.md) for full details on:
...
A comprehensive glossary covering MCP, Playwright, RAG, LLMs, and 30+ more terms is in [docs/glossary.md](docs/glossary.md).

---

## Resources & Further Reading

Curated links to official docs, tutorials, and community projects are in [docs/resources.md](docs/resources.md).
